...
#A genome is an individual in a population.
    ...
    for genomeID, genome in genomes:
        ...
        #Defines the structure of environment observations.
        ...
        while not done:
            ...
            #Shapes the size of the array and initialises the game window,
            #allowing the game to run on screen.
            ...
            #360 piexels have been added to this value so Sonic passes it.
                ...
                #their current fitness is set to 100,000.
...
configure = neat.Config(neat.DefaultGenome, neat.DefaultReproduction, neat.DefaultSpeciesSet, neat.DefaultStagnation, 'config-feedforward')
